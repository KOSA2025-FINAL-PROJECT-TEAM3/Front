...
1. **Medication API 연동**: `src/features/medication/store/medicationStore.js`가 mock 데이터를 사용하는 상태라, Stage 4 CRUD 완료를 위해 `src/core/services/api/medicationApiClient.js`와 실제 엔드포인트를 연결해야 합니다.
