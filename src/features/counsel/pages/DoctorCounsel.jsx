    ...
    <MainLayout>
      <div className={styles.page}>
        <header className={styles.header}>
          <h1>의사와 상담</h1>
          <p>궁금한 내용을 작성해 상담을 신청해 보세요 (모의)</p>
        </header>
        ...
        <section className={styles.panel}>
          ...
          <textarea
            ...
            placeholder="예: 최근 두통이 잦아요, 복용 중인 약과 식품 상호작용이 걱정됩니다"
            rows={6}
            value={message}
          ...
          <div className={styles.actions}>
            <button
              ...
              onClick={async () => {
                ...
                const res = await counselApiClient.submit(message.trim())
                alert(`상담 신청이 등록되었습니다! 티켓: ${res.ticketId}`)
                setMessage('')
              }}
            >
              상담 신청 (Mock)
