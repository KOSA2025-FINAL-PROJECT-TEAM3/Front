...
export const FamilyMemberDietPage = () => {
      ...
      <PageStack>
        ...
        {isLoading ? (
          ...
          <>
            ...
            {userId ? <DietLogsTab userId={Number(userId)} /> : <Alert severity="warning">사용자 정보를 찾을 수 없습니다.</Alert>}
          </>
        )}
      </PageStack>
    </MainLayout>
...
export default FamilyMemberDietPage
